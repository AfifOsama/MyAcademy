...
import com.madman.academybajp.utils.LiveDataTestUtil
...
class AcademyRepositoryTest {
    ...
    @Test
    fun getAllCourses() {
        // ketika remote.getAllCourse dipanggil maka akan dijawab atau mendapatkan balikan nilai courseResponse
        doAnswer { invocation ->
            (invocation.arguments[0] as RemoteDataSource.LoadCoursesCallback)
                .onAllCoursedReceived(courseResponses)
            null
